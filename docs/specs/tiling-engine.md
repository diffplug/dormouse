...
- **Must host Terminal Context above the tiled leaves**, keeping its terminal mounted during placement changes. `docs/specs/layout.md` → Header context menu owns placement.
