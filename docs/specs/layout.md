...
| `lib/src/components/wall/programmatic-activation.ts` | `withProgrammaticActivation` depth-tag distinguishing programmatic add-side dockview activation from user activation |
