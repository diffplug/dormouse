...
- **Must keep the outgoing Workspace visible and inert beneath the incoming Workspace during a switch**, fading over the app background with the same duration and easing. Keep its terminal elements attached until the fade finishes; a rapid switch back resumes from the displayed frame.
