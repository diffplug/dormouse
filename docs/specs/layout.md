...
- **Must fade inactive tab backgrounds from 70% of their height (near the text baseline) to the bottom**, ending at an sRGB mix of 30% inactive-header background and 70% app background.
