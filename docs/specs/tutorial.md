...
computed from section checklist items only; `Starred on GitHub` and the Flappy
row do not count. When all section tasks are complete, the row shows a
