...
notifications**, offered full-width on the first connect and on the Host's row
thereafter, which is the user gesture iOS requires before it will prompt for
