...
**The owner alone acts on the events** its parse produced — writing the responses, feeding its `AlertManager`, recording the semantic state — and hands every consumer the same chunk ([remote-api.md](remote-api.md#terminal-surfaces)).
