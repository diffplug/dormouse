import type { ResolvedSessionFlags } from './browser-cli.js';
...
export { extractSessionFlags, resolveBinaryPath } from './browser-cli.js';
import type {
...
export async function runAgentBrowserCli(args: string[], options: CliOptions): Promise<CliResult> {
  ...
  // an explicit path, simply "returned verbatim", which browserBinaryIsMissing
  // re-checks on disk.
