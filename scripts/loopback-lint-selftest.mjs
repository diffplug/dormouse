 ...
 * lint stayed green on both, while `docs/specs/security-application.md` claimed a new loopback bind
...
selftest.finish(
  ...
  + 'clause in docs/specs/security-application.md -> "Loopback Listeners" is not true of it.',
);
