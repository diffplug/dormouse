...
function WorkspaceTeardownModalStory({ confirming, archiveError }: { confirming: boolean; archiveError?: string | null }) {
  ...
  return (
    <div className="relative h-[420px] w-[720px] overflow-hidden rounded bg-app-bg p-4 font-mono text-sm text-terminal-fg">
      ...
      <WorkspaceTeardownModal confirming={confirming} archiveError={archiveError} />
    </div>
  );
}
