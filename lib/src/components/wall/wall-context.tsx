...
/** Exact zoom owner for pane-local chrome. Kept separate from the public boolean
 * projection so partially exposed panes do not render another pane's Unzoom state. */
